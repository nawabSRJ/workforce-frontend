...
export default function ServiceCard({ name, desc, image }) {
  ...
  return (
    <div className={`w-[180px] sm:w-[220px] min-h-[240px] sm:min-h-[280px] flex flex-col items-center ${bgCol} shadow-md hover:shadow-lg transition-all duration-300 border  rounded-lg overflow-hidden p-3`}>
