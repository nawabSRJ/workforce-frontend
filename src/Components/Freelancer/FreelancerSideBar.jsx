...
import { Menu, X, Home, Folder, Mail, ListChecks, Bell, LogOut } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

export default function FreelancerSideBar({ select, setSelect }) {
    ...
    const menuItems = [
        ...
        { name: 'Todo', icon: <ListChecks className="w-5 h-5" /> },
        { name: 'Reminders', icon: <Bell className="w-5 h-5" /> }
    ];
